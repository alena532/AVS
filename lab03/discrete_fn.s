...
case1:   .asciiz "f(-6) should be 1, and it is: "
case2:   .asciiz "f(-5) should be 26, and it is: "
case3:   .asciiz "f(-4) should be 41, and it is: "
case4:   .asciiz "f(-3) should be -50, and it is: "
case5:   .asciiz "f(-2) should be 32, and it is: "
case6:   .asciiz "f(-1) should be -31, and it is: "
case7:   .asciiz "f(0) should be 23, and it is: "

# FIXME Разместите значения из вашего варианта в этом массиве 
output: .word   1, 26, 41, -50, 32, -31, 23
...
main:
    ...
    # выполняем f(case1)
    jal f     
    # f вернет результат f(-6) в регистре a0
